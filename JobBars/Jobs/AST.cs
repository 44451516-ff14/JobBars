...
namespace JobBars.Jobs
{
    public static class AST
    {
        ...
        [
            new GaugeProcsConfig( $"{UiHelper.Localize( JobIds.AST )} {UiHelper.ProcText}", GaugeVisualType.Diamond,
                new GaugeProcProps
                {
                    Procs =
                    [
                        new ProcConfig( UiHelper.Localize( BuffIds.GiantDominance ), BuffIds.GiantDominance,
        ...
        [
            ...
            new CooldownConfig( UiHelper.Localize( ActionIds.天星冲日 ), new CooldownProps
            {
                Icon = ActionIds.天星冲日,
                CD = 60,
                Triggers = [new Item( ActionIds.天星冲日 )]
            } ),
            ...
            new CooldownConfig( $"{UiHelper.Localize( ActionIds.Swiftcast )} ({UiHelper.Localize( JobIds.AST )})",
                new CooldownProps
                {
