...
namespace JobBars.Jobs
{
    public static class NIN
    {
        ...
        [
            new GaugeStacksConfig( UiHelper.Localize( BuffIds.RaijuReady ), GaugeVisualType.Diamond,
            ...
            new GaugeChargesConfig( $"{UiHelper.Localize( ActionIds.TrueNorth )} ({UiHelper.Localize( JobIds.NIN )})",
                GaugeVisualType.BarDiamondCombo, new GaugeChargesProps
                {
        ...
        [
            new CooldownConfig( $"{UiHelper.Localize( ActionIds.Feint )} ({UiHelper.Localize( JobIds.NIN )})",
                new CooldownProps
                {
            ...
            new CooldownConfig( UiHelper.Localize( ActionIds.残影 ), new CooldownProps
            {
                Icon = ActionIds.残影,
                CD = 120,
                Triggers = [new Item( ActionIds.残影 )]
            } ),
