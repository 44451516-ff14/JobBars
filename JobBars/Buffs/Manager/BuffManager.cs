...
namespace JobBars.Buffs.Manager {
    public unsafe partial class BuffManager : PerJobManager<BuffConfig[]> {
        ...
        public void PerformAction( Item action, uint objectId ) {
            ...
            if( !JobBars.Configuration.BuffIncludeParty && objectId != Dalamud.LocalPlayer.GameObjectId ) return;
        ...
        public void Tick() {
            ...
            for( var idx = 0; idx < JobBars.PartyMembers.Count; idx++ ) {
                ...
                if( !JobBars.Configuration.BuffIncludeParty && partyMember.ObjectId != Dalamud.LocalPlayer.GameObjectId ) continue;
